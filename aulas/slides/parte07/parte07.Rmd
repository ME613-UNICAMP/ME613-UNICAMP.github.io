...
Quando $X_2$ é adicionada ao modelo contendo apenas $X_1$, a $SQE(X_1)$ é reduzida 23%.

Quando $X_3$ é adicionada ao modelo contendo $X_1$ e $X_2$, a $SQE(X_1,X_2)$ é reduzida 10%.
...
O diagram de dispersão de $e_i(Y\mid X_2)$ versus $e_i(X_1\mid X_2)$ fornece uma representação gráfica da relação entre $Y$ e $X_1$, ajustada por $X_2$. É também chamado de *added variable plot* ou **gráfico de regressão parcial**.
...
<center>
<img src="figuras/null_hypothesis.png" width=180>
</center>
