...
$$F^*_{obs}=\frac{[SQE(Reduced)-SQE(Full)]/2}{SQE(Full)/4}=\frac{`r (anova(Reduced)[2,2]-anova(Full)[2,2])`/`r (anova(Reduced)[2,1]-anova(Full)[2,1])`}{`r anova(Full)[2,2]`/`r anova(Full)[2,1]`}=`r round(anova(Reduced,Full)[2,5],2)`$$
